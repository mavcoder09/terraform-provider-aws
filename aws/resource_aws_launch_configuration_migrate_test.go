...
func TestAWSLaunchConfigurationMigrateState(t *testing.T) {
	cases := map[string]struct {
		...
		"#1": {
			...
			Expected: map[string]string{
				"ebs_block_device.#":                               "1",
				"ebs_block_device.994269717.delete_on_termination": "false",
				"ebs_block_device.994269717.device_name":           "/dev/sda2",
				"ebs_block_device.994269717.encrypted":             "false",
				"ebs_block_device.994269717.iops":                  "0",
				"ebs_block_device.994269717.snapshot_id":           "",
				"ebs_block_device.994269717.volume_size":           "0",
				"ebs_block_device.994269717.volume_type":           "",
			},
		},
	}
